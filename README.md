...
Datos cargados
La base de datos se inicializa automáticamente con 151 Pokémon correspondientes a la primera generación mediante el script init.sql.
...
Incidencia 2: Error de acceso a la imagen
Causa:
Portainer intentaba descargar una imagen que solo existía de forma local.

Solución:
Asignar un tag correcto a la imagen local y utilizar image en lugar de build.
...
Solución:
Comprobar los contenedores activos con docker ps.
...
Conclusión
El proyecto demuestra el despliegue correcto de una aplicación web conectada a una base de datos MySQL mediante contenedores Docker y gestionada con Portainer, cumpliendo los objetivos de persistencia, comunicación entre servicios y organización del entorno.
